...
Please post your question in the forum under **[Support forum](http://wordpress.org/tags/fitcash?forum_id=10#postform)** .  
...
= 1.1.0 =
- JBF Import Posts Plugin changed into Fitcash 

= 1.1.1 =
- feature added: spinning text 
...
= 1.3.2 =
- error fixed: option array not saved completely
...
= 1.3.6 =
- version problem in svn repository fixed
